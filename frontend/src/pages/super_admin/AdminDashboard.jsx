      ...
      <div className="hidden md:flex w-64 bg-white border-r border-gray-200 flex-col">
        <div className="p-6">
          <h1 className="text-xl font-black text-blue-600 tracking-tighter">
            TRUKEN<span className="text-gray-800">GO</span>
          </h1>
        ...
        <nav className="flex-1 px-4 space-y-2">
          ...
          <button
            ...
            className="w-full p-3 text-gray-600 hover:bg-gray-100 rounded-xl flex items-center gap-3 text-sm transition-all text-left"
          >
        ...
        <div className="p-4 border-t border-gray-100">
          <button
            ...
            className="w-full p-3 text-red-500 hover:bg-red-50 rounded-xl flex items-center gap-3 text-sm font-bold transition-all"
          >
        ...
        <main className="p-6 md:p-10 max-w-5xl">
          <header className="mb-8">
            ...
            <p className="text-gray-500 text-sm">
              Kelola operasional jastip TrukenGo hari ini.
            </p>
          </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col justify-between">
              <div>
                ...
                <h3 className="font-bold text-gray-800">
                  Lokasi Utama (Basecamp)
                </h3>
                <p className="text-xs text-gray-500 mb-4">
                  Patokan jarak awal untuk cek ongkir.
                </p>
              </div>
              <button
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
              <div className="w-12 h-12 bg-sky-600 text-white rounded-2xl flex items-center justify-center mb-4">
                <Tag size={24} />
              </div>
              <h3 className="font-bold text-gray-800">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Atur biaya pickup, delivery, dan fee tetap.
              </p>
              <button
                onClick={() => navigate("/super-admin/edit-config")}
                className="w-full bg-blue-600 text-white py-3 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20 mt-4"
              >
                Edit Tarif
              </button>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 md:col-span-2 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Daftarkan driver baru ke dalam sistem jastip.
                  </p>
                </div>
              </div>
              <button
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={i}
                className="bg-white p-4 rounded-2xl border border-gray-100 text-center"
              >
